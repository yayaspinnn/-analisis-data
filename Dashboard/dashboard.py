...
plt.bar(x=workingday_trend.index, height=workingday_trend, color=['orange', 'blue'])
...
fig_holiday = plt.figure(figsize=(12, 6))
plt.bar(x=holiday_trend.index, height=holiday_trend, color=['orange', 'blue'])
plt.xlabel('Holiday')
plt.ylabel('Rata-rata jumlah pengguna')
